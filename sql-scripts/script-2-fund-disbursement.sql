-- ============================================================================
-- 4CORE OKR PLATFORM - FINANCIAL MODULE PART 2
-- Fund Disbursement, Violation Ledger, Mini-Ledger
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS fund_requests (
  ...
  status TEXT DEFAULT 'REQUESTED' CHECK (status IN (
    'REQUESTED', 'APPROVED_FINANCE', 'APPROVED_SUPER_ADMIN', 'DISBURSED', 'REJECTED'
  )),
  requested_by UUID,
...
BEGIN
  ...
  VALUES (
    p_violation_id, p_user_id, 'User', p_amount,
